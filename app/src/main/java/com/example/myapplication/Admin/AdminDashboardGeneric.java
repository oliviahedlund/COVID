...
public class AdminDashboardGeneric extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_dashboard_generic);
    ...
    private void setUpNavigationView() {
        ...
        logoutButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(AdminDashboardGeneric.this, MainActivity.class);
